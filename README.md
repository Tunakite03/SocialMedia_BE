...
- **Video/Audio Calls**: LiveKit integration for high-quality voice and video calling
...
**We've migrated from WebRTC to LiveKit for better call quality and easier maintenance!**

**What's New:**

- Simplified call setup (30 lines vs 200+ lines)
...
- [Quick Start Guide](QUICK_START_LIVEKIT.md) - Get started in 5 minutes
- [Migration Guide](LIVEKIT_MIGRATION.md) - Full migration details
- [Implementation Summary](LIVEKIT_IMPLEMENTATION_SUMMARY.md) - What changed
- [API Reference](src/services/LIVEKIT_SERVICE_README.md) - LiveKit service docs

🧪 **Test LiveKit:** `npm run livekit:test`
...
- **LiveKit**: Video/audio call infrastructure (replaces WebRTC signaling)
